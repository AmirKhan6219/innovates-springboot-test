...
public class CompanyController {
	...
	public ResponseEntity<CompanyDTO> getCompanyById(@PathVariable Long id) {
		...
		return ResponseEntity.ok(companyMapper.getCompanyDTO(company));
	}
	...
	public ResponseEntity<CompanyDTO> partialUpdateCompany(
		...
		Company updatedCompany = companyService.updateCompanyPartially(id, companyMapper.getCompany(companyDTO));
